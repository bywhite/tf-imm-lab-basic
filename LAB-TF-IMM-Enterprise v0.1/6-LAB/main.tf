...
# There are many opportunities to re-use code in Terraform for use with Intersight.
...
# We will call our new module "ip_pool1"
# uncomment the following code to call the new module
...
# -----------------------------------------------------------------------------------
# Step 4     ----------------------------------------------------------------------
#  That is enough to create the pool, but we need the MOID to be able to associate it 
#    with the chassis policy
